/** Default editable prefix — verbatim from Resume-sender DEFAULT_PROMPT_TEMPLATE. */
export const DEFAULT_PROMPT_PREFIX = `You are a STATELESS AI system.
...
export const LOCKED_PROMPT_SUFFIX = `=== CHAT HISTORY ISOLATION (MANDATORY) ===
